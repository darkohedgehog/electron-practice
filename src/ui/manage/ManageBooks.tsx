...
const ManageBooks = () => {
  ...
  // Handler za promenu slike u modal formi
  const handleChangeImage = async () => {
    try {
      // Otvori nativni dijalog za odabir slike
      const selectedFilePathRaw = await window.api.openFileDialog();
      // Ako handler vraća niz, uzmi prvi element
      ...
      // Kopiraj fajl u folder 'images' i dobij naziv fajla
      ...
      // Ažuriraj formData sa novim nazivom fajla
  ...
  return (
    <div className="p-8 ml-48">
      ...
      {/* Renderuj tabelu samo ako modal nije aktivan */}
      {!editingBook && (
        <>
          {books.length === 0 ? (
